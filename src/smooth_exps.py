...
for roth in [True, False]:
    ...
    for dataset in dataset_names:
        ...
        einet = EinsumNetwork.EinsumNetwork(graph, args, roth=roth)
        einet.initialize()
        einet.to(device)
        #print(einet)
        ...
        if use_em:
            for epoch_count in range(max_num_epochs):
                ...
                #results[dataset].append([train_ll / train_N, valid_ll / valid_N, test_ll / test_N])
            ...
            for epoch_count in range(max_num_epochs):
                ...
                #einet.em_update()
    if roth:
        overall_results["roth"] = results
    else:
        overall_results["einet"] = results
